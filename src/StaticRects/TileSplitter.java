...
public class TileSplitter {
    ...
    public BufferedImage filterImage(BufferedImage unfilteredImage) {
        ...
        filteredImage = MakeColorTransparent(unfilteredImage, Color.magenta); //new Color(0).blue);
